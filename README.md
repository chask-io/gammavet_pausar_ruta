...
Pausa la ruta o sesion de un conductor Gammavet y envia confirmacion por WhatsApp
...
- The function name matches "PausarRutaFn"
...
- AWS CloudWatch Logs: `/aws/lambda/PausarRutaFn`
- Chask dashboard: Organization → Functions → PausarRutaFn
